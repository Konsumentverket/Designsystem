...
var InputStyle = function InputStyle(hasInnerContent) {
  return (0, _css["default"])(_templateObject(), hasInnerContent ? '4.5rem' : '1.6rem', _Colors.colors.theme3.midLight, _Colors.colors.theme1.mid, _Colors.colors.theme3.mid);
};
